"""
In this module the neural net will be trained with paintings only of a separate dataset
"""
...
PATH2MODEL = "./models/whole_art_model.pth"
...
dataset = PaintingDataset(annotations = "data/annotations.csv", root_dir = "data/arrays64", 
...
writer_real = SummaryWriter(f"long_train/GAN_Paintings/real_images")
writer_fake = SummaryWriter(f"long_train/GAN_Paintings/fake_images")
