"""
In this module the neural net will be trained
"""
...
dataset = PaintingDataset(annotations = "data/annotations.csv", root_dir = "data/arrays", 
...
optimD = optim.Adam(netD.parameters(), lr = 0.0002, betas = (0.25, 0.85))
optimG = optim.Adam(netG.parameters(), lr = 0.0002, betas = (0.25, 0.85))
...
writer_real = SummaryWriter(f"runs_raw/GAN_Paintings/real_images")
writer_fake = SummaryWriter(f"runs_raw/GAN_Paintings/fake_images")
